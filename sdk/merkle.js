...
export class SarrunMerkleTree {
  ...
  append(commitment) { if (this.leaves.length >= 2 ** this.depth) throw new Error('Sarrun tree is full'); this.leaves.push(BigInt(commitment)); return this.leaves.length - 1 }
