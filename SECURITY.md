...
Sarrun separates spending keys from viewing/disclosure keys. It targets graph unlinkability inside shielded state; it does not hide RPC provider, browser, device, timing, amount-pattern, public entry, public exit, or compromised-wallet metadata.
